...
import { ArrowLeft, Database, ArrowRight, Shield } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Architecture",
  description: "System architecture documentation for NexusCanon Vendor Governance Platform",
};
...
const ARCHITECTURE_LINKS = [
  ...
  {
    title: "Data Flow",
    description: "Understanding how data flows through the platform",
    href: "/docs/architecture/data-flow",
    icon: ArrowRight,
  },
  {
    title: "Security",
    description: "Security architecture and zero-trust principles",
