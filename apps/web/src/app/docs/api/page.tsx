...
import { ArrowLeft, Key, Code, Gauge } from "lucide-react";
...
export const metadata: Metadata = {
  title: "API Reference",
  description: "Complete API reference for NexusCanon Vendor Governance Platform",
};
      ...
      <main className="max-w-4xl mx-auto px-6 md:px-12 py-16">
        <div className="mb-12">
          ...
          <p className="text-lg text-foreground-muted font-normal leading-relaxed">
            Complete API documentation for integrating with NexusCanon.
          </p>
        </div>
